...
const NavBar = () => {
  ...
  return (
    <nav className="w-full px-8 py-4 flex flex-col md:flex-row md:items-center justify-between text-white font-medium bg-black relative z-50">
      ...
      {/* Center - Nav Options (Visible on Desktop) */}
