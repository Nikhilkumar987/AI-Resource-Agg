...
<div className="relative flex  gap-8 px-4 py-4 text-white text-md rounded-full bg-white/10 backdrop-blur-md inset_0_1px_0_rgba(255,255,255,0.5),inset_0_-1px_0_rgba(255,255,255,0.1)] left-[00px] ">
  <a href="#" className="text-white font-semibold flex items-center gap-1 hover:text-purple-300 transition">
   Home
  </a>
  <a href="#" className="text-white hover:text-purple-300 transition">Docs</a>
  <a href="#" className="text-white hover:text-purple-300transition">Showcase</a>
</div>
      ...
      <div className='hidden md:block'>
        ...
        >
          ...
          <span className="bg-black px-2 py-1 rounded-full flex items-center gap-1 text-xs font-semibold">
            <Star className="w-3 h-3 fill-white" /> 18.8K
          </span>
        </a>
      </div>
